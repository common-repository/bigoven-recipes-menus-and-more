...
<div class="bo-recipe" style="border: <?php echo bo_recipes_get_setting_border(); ?>">
	<div class="hrecipe h-recipe" rel="<?php echo esc_html($recipe->ID); ?>">
		...
		<ul class="duration-list">
			...
			<li class="duration dt-duration"><span class="value-title" title="<?php echo esc_attr(bo_recipes_get_time_preparation_duration($recipe->ID)); ?>"><?php _e('Prep time'); ?>:</span> <?php echo esc_html($time_preparation); ?></li>
			<?php } ?>
